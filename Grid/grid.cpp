...
public:
    ...
    MovingObject(SDL_Renderer* renderer, int size, int gridSize, int initialX, int initialY) :
        renderer(renderer),
        size(size),
        gridSize(gridSize),
        x(initialX),
...
int main(int argc, char* argv[]) {
    ...
    MovingObject object1(renderer, CELL_SIZE, GRID_SIZE, initialX1, initialY1);
    MovingObject object2(renderer, CELL_SIZE, GRID_SIZE, initialX2, initialY2);
